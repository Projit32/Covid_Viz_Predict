...
mc = ModelCheckpoint('best_model_cumulative.h5', monitor='loss', mode='min', verbose=1, save_best_only=True)

regressor.fit(X_train, y_train, epochs = 25,  batch_size = 4, callbacks=[mc])

regressor=load_model('best_model_cumulative.h5')
...
plt.plot(y_test, color = 'red', label = 'Real Total cases')
