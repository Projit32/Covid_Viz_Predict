...
We generate the visualizations using Tableau, which you can be accessed from [here](https://public.tableau.com/views/COVID-19India_15884306164120/COVID-19?:language=en-US&:display_count=n&:origin=viz_share_link), for the following :
